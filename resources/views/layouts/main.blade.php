        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row align-items-center mb-2">
              <div class="col">
                <h2 class="h5 page-title">Welcome Rizal Khoirul AAA !</h2>
              </div>
              <div class="col-auto">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        ...
                        <h3 class="card-title mb-0">                          <h3>0</h3>                                                    <small class="text-muted mb-1"> &nbsp; &nbsp;Viewers</small>
                        </h3>
...
var lineChartjs = document.getElementById('lineChartjs');
        var lineChartjs = new Chart(lineChartjs, {
          type: 'line',
          data: {
            labels: ["20-03-2022","24-11-2022","06-12-2022","11-12-2022","12-12-2022","14-12-2022","17-12-2022","22-12-2022","23-12-2022","26-12-2022","03-01-2023"], // Merubah data tanggal menjadi format JSON
            datasets: [{
              label: 'Data Penghasilan',
              data: ["1000000","3000000","1200000","1000000","2000000","4200000","1920000","230000","1000000","2188000","1000000"],
                    borderColor: "#29B0D0",
